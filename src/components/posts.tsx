...
import { getAllPublishedPosts, Post } from '@/lib/posts'
...
const PostCard = ({ post }: PostCardProps) => {
  return (
    <div className="group border-b border-b-neutral-300 dark:border-b-neutral-700 last:border-0">
      ...
      >
        <h2 className="post-title group-hover:opacity-60 dark:tracking-wider dark:group-hover:opacity-80 transition-all duration-300">
          {post.title}
        </h2>

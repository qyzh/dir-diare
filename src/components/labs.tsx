...
import { getAllArtPosts, ArtPost } from '@/lib/artpost'
import UkCLI from '@/components/ui/ukcli'
...
const PostCard = ({ post }: PostCardProps) => {
    return (
        <div className="border-b border-neutral-300 dark:border-b-neutral-700 last:border-0 py-4">
            <Link
                href={`/l/${post.slug}`}
                key={post.slug}

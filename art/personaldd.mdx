...
## Item
<Image size='large' alt="Item Page" src='/images/art/item.png'/>

## Profile
<Image size='large' alt="Profile page" src='/images/art/pddrofile.png'/>

## History Match
<Image size='large' alt="History page!" src='/images/art/history.png'/>

## Getting Started
You can find the project on GitHub at [PersonalD2](https://github.com/qyzh/PersonalD2) . Feel free to contribute, suggest features, or report issues.

...
import { ArrowDownIcon, MagicWandIcon } from "@radix-ui/react-icons";
...
<div className="space-y-8 px-2">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex flex-col pt-4">
              ...
              <div className="">
                <div className="inline-flex space-x-1 items-center mt-2 leading-none">
                  <div className="text-xs px-2.5 py-0.5 border border-fuchsia-800 bg-fuchsia-900/50 text-fuchsia-400 rounded-full">
                  <MagicWandIcon className="inline mr-1"/> Junior UI/UX 
                  </div>
                  <div className="text-xs px-2.5 py-0.5 border border-emerald-800 bg-emerald-900/50 text-emerald-400 rounded-full">
                  ...
                  Amature Runner </div>
                  <div className="text-xs px-2.5 py-0.5 border border-rose-800 bg-rose-900/50 text-rose-400 rounded-full">

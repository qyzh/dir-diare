...
import { Code as Pin, Link2, AlertTriangle, Wrench } from 'lucide-react'
...
function Gitlink ({src, repo}) {
    return (
        <Link href={src} target='_blank' className='inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-white/5 hover:bg-purple-700/30 transition-colors border border-zinc-700/50'>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50" className='text-zinc-300'>

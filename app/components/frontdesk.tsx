...
export default function FrontDesk() {
  const linkClassName = "front-link text-neutral-700 dark:text-neutral-100 hover:text-neutral-900 dark:hover:text-neutral-100 hover:underline underline-offset-4"

  return (
    <div>
      <div className='my-4'>
        <div className='flex justify-baseline items-center space-x-1.5'>
          <h1 className='font-bold'>Dir-diare</h1><span className='italic text-sm mt-1.5'>(noun)</span>
        </div>
        <div><span className='text-fonetik font-semibold italic'>dɪr−diˈɑːrɛ</span></div>
      </div>

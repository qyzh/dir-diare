    ...
    >
        <div className="flex flex-col gap-2 p-4 justify-between">
            ...
            <div className="flex">
              {date && 
                <span className="text-xs flex items-center text-white/50">
                    <CalendarHeart className="inline w-4 h-4 mr-1" /><span className="hover:text-white/80 transition-colors">{date}</span></span>
              }
              <Dot className="inline w-4 h-4 text-white/30 mx-0.5" />
              {place && 
                <span className="text-xs flex items-center text-white/50">
                    <Map className="inline w-4 h-4 mr-1" /><span className="hover:text-white/80 transition-colors">{place}</span></span>
              }
            </div>
            ...
            <div className="text-sm flex flex-col items-center justify-center text-white/50 bg-black/50 p-4 rounded">
                <div className="hover:text-white/80 transition-colors font-mono tabular-nums">{distance}km</div> 
            ...
            <div className="text-sm flex flex-col items-center justify-center text-white/50 bg-black/50 p-1 rounded">
                <div className="hover:text-white/80 transition-colors font-mono tabular-nums">{time}</div> 
                <div className="text-white/50">Time</div>
            </div>
            }
            {pace && 
            <div className="text-sm flex flex-col items-center justify-center text-white/50 bg-black/50 p-1 rounded">
                <div className="hover:text-white/80 transition-colors font-mono tabular-nums">{pace}min/km</div>

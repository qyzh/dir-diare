...
<Image src={d.metadata.image || '/images/bg-noise.png'}  fill={true}
        className="absolute inset-0 h-full w-full grayscale group-hover:grayscale-0 overflow-hidden object-cover object-center opacity-75 rounded transition-opacity group-hover:opacity-50" alt={''}  />
  <div className="relative p-4 sm:p-6 lg:p-8">

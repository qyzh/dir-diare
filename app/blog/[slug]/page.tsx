...
export default function Blog({ params }) {
    ...
    return (
        <section>
            ...
            <div className="flex flex-row items-center gap-x-2 font-mono text-m text-neutral-600 dark:text-neutral-400 mb-2">
                ...
                <time className='proportional-nums ' dateTime={post.metadata.publishedAt} >{formatDate(post.metadata.publishedAt, true)}</time>
                <Link
                    href="#comments"
                ...
                <TimerIcon className='inline-block stroke-sky-500'/><div className="mt-0.5">{readTime(post.content)}</div>
            </div>

...
const NowPlay: React.FC = () => {
    ...
    if (error) {
        return (
            <div className="flex items-center gap-4 p-4 border border-transparent hover:bg-red-500/10 hover:border-red-800 transition-colors rounded">
                ...
                <div className="track-details space-y-1 font-mono">
                    <div className="space-y-3">
                        <h2 className="text-xl font-bold text-neutral-100">
                            3Rr0r
                            <span className="relative ml-2 px-2 py-0.5 text-xs font-semibold bg-rose-500/20 text-rose-400 rounded">
            ...
            <div className="flex items-center gap-4 p-4 border border-transparent  hover:bg-neutral-700 hover:border-neutral-800 transition-colors rounded">
                ...
                <div className="track-details space-y-1 font-mono">
                    <div className="space-y-3">
                        <h2 className="text-xl font-bold text-neutral-100">
                            Not Playing
                            <span className="relative ml-2 px-2 py-0.5 text-xs font-semibold bg-gray-500/20 text-gray-400 rounded">
                                <span className="absolute -top-1 -right-1 flex h-2 w-2">
    ...
    return (
        <div className="now-play-container">
            <main className="now-play-content">
                {nowPlaying.item && (
                    <div className="flex items-center border border-transparent gap-4 p-4 hover:bg-emerald-500/10 hover:border-emerald-800 transition-colors rounded">
                        <div className="relative w-32 h-32">
                            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-neutral-900 to-neutral-800 shadow-2xl animate-spin">
                                <div className="absolute inset-2 rounded-full bg-gradient-to-br from-neutral-800 to-neutral-900"></div>
                                <div className="absolute inset-4 rounded-full bg-gradient-to-br from-neutral-900 to-neutral-800"></div>
                        ...
                        <div className="track-details space-y-1 font-mono">
                            <h2 className="text-xl font-bold text-neutral-100">
                                ...
                                <span className="relative ml-2 px-2 py-0.5 text-xs font-semibold bg-green-500/20 text-green-400 rounded">
                                    <span className="absolute -top-1 -right-1 flex h-2 w-2">
